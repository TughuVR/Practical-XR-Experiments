...
function xrSessionEvent(eventType, callback) {
    ...
    if (_pGlob.xrSessionAcquired) {
        appInstance.xrControllers.forEach(function(controller) {
            bindListener(controller, eventType, eventHandler);
        });
    }
...
eventHTMLElem('click', ['DOCUMENT'], false, function(event) {
  if (sounds_is_played == false) {
    ...
    "all_buttons": { get: function() { return all_buttons; }, set: function(val) { all_buttons = val; } },
    "animated_objects": { get: function() { return animated_objects; }, set: function(val) { animated_objects = val; } },
    "nozzle_dop_limit": { get: function() { return nozzle_dop_limit; }, set: function(val) { nozzle_dop_limit = val; } },
    "manipulator_color_1": { get: function() { return manipulator_color_1; }, set: function(val) { manipulator_color_1 = val; } },
    "manipulator_color_2": { get: function() { return manipulator_color_2; }, set: function(val) { manipulator_color_2 = val; } },
    "interface_color": { get: function() { return interface_color; }, set: function(val) { interface_color = val; } },
    "transparent_color": { get: function() { return transparent_color; }, set: function(val) { transparent_color = val; } },
    "clicked": { get: function() { return clicked; }, set: function(val) { clicked = val; } },
    "manipulators_list": { get: function() { return manipulators_list; }, set: function(val) { manipulators_list = val; } },
    "mode_type": { get: function() { return mode_type; }, set: function(val) { mode_type = val; } },
    "nozzle_installed": { get: function() { return nozzle_installed; }, set: function(val) { nozzle_installed = val; } },
    "color_mode": { get: function() { return color_mode; }, set: function(val) { color_mode = val; } },
    "nozzles_list": { get: function() { return nozzles_list; }, set: function(val) { nozzles_list = val; } },
    "nozzles_status": { get: function() { return nozzles_status; }, set: function(val) { nozzles_status = val; } },
    "robot_coloring_list": { get: function() { return robot_coloring_list; }, set: function(val) { robot_coloring_list = val; } },
    "robot_parts_list": { get: function() { return robot_parts_list; }, set: function(val) { robot_parts_list = val; } },
    "robot_slected_part": { get: function() { return robot_slected_part; }, set: function(val) { robot_slected_part = val; } },
    ...
    "animation_1_playing": { get: function() { return animation_1_playing; }, set: function(val) { animation_1_playing = val; } },
    "animation_2_playing": { get: function() { return animation_2_playing; }, set: function(val) { animation_2_playing = val; } },
    "animation_3_playing": { get: function() { return animation_3_playing; }, set: function(val) { animation_3_playing = val; } },
    "ar_animation_index": { get: function() { return ar_animation_index; }, set: function(val) { ar_animation_index = val; } },
    "all_sounds_list": { get: function() { return all_sounds_list; }, set: function(val) { all_sounds_list = val; } },
    "sounds_is_played": { get: function() { return sounds_is_played; }, set: function(val) { sounds_is_played = val; } },
    "i": { get: function() { return i; }, set: function(val) { i = val; } },
    "help_showed": { get: function() { return help_showed; }, set: function(val) { help_showed = val; } },
    "help_visible": { get: function() { return help_visible; }, set: function(val) { help_visible = val; } },
    "vr_available": { get: function() { return vr_available; }, set: function(val) { vr_available = val; } },
    "button_1_hovered": { get: function() { return button_1_hovered; }, set: function(val) { button_1_hovered = val; } },
    "button_2_hovered": { get: function() { return button_2_hovered; }, set: function(val) { button_2_hovered = val; } },
    "button_1_value": { get: function() { return button_1_value; }, set: function(val) { button_1_value = val; } },
    "button_3_hovered": { get: function() { return button_3_hovered; }, set: function(val) { button_3_hovered = val; } },
    "button_2_value": { get: function() { return button_2_value; }, set: function(val) { button_2_value = val; } },
    "button_3_value": { get: function() { return button_3_value; }, set: function(val) { button_3_value = val; } },
    "ar_available": { get: function() { return ar_available; }, set: function(val) { ar_available = val; } },
    "ar_mode_on": { get: function() { return ar_mode_on; }, set: function(val) { ar_mode_on = val; } },
    "ar_base_fixed": { get: function() { return ar_base_fixed; }, set: function(val) { ar_base_fixed = val; } },
});
