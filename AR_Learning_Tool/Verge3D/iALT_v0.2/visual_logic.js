...
registerOnClick(['ALL_OBJECTS'], false, false, [0,1,2], function() {
  registerOnDrag(_pGlob.pickedObject, false, [0], function() {}, function() {
    dragMove(_pGlob.pickedObject, 'XYZ', 'X08AQBOM!d@meh]jtD:*', 'dEsSVJ%pX0-bp*Db3P4p');
  }, function() {}, 'dEsSVJ%pX0-bp*Db3P4p');
}, function() {});

registerOnClick(['ALL_OBJECTS'], false, false, [2], function() {
  snapToObject(_pGlob.pickedObject, 'empty_Skull');
}, function() {});

registerOnClick(['ALL_OBJECTS'], false, false, [1], function() {
  changeVis(['ALL_OBJECTS'], false);
  changeVis(_pGlob.pickedObject, true);
}, function() {
